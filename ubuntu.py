...
def set_repo():
    try:
        check_call(["wget", "http://apt.puppetlabs.com/puppetlabs-release-precise.deb"])
        print "Download the puppetlabs deb."
        check_call(["dpkg", "-i", "puppetlabs-release-precise.deb"])
